...
void main() {
  group("test JSON serialization", () {
    ...
    test("fromJson should correctly map all fields from JSON", () {
      ...
      expect(
          fromJson.muscles?[0].image, equals('https://example.com/bench.jpg'));
  ...
  group("test Equatable", () {
    ...
    test("two MusclesRandomResponse instances with null values should be equal",
        () {
      // Arrange
      const response1 = MusclesRandomResponse(
        message: null,
    ...
    test("two MusclesRandomResponse instances with empty list should be equal",
        () {
      // Arrange
      const response1 = MusclesRandomResponse(
        message: "success",
