...
void main() {
  group("test toEntity", () {
    test(
      ...
      () {
        ...
        // Act
        final MusclesGroupIdResponseEntity actualResult =
            muscleGroupIdResponse.toEntity();

        // Assert
        expect(actualResult.message, equals(muscleGroupIdResponse.message));
        expect(
            actualResult.musclesGroup, equals(muscleGroupIdResponse.musclesGroup));
    ...
    test(
      ...
      () {
        ...
        expect(actualResult.musclesGroup?.id,
            equals(muscleGroupIdResponse.musclesGroup?.id));
        expect(actualResult.musclesGroup?.name,
            equals(muscleGroupIdResponse.musclesGroup?.name));
        expect(actualResult.musclesGroup?.id, equals("67c79f3526895f87ce0aa96b"));
        ...
        expect(actualResult.muscles?[0].image,
        ...
        expect(actualResult.muscles?[1].image,
  ...
  group("test Equatable", () {
    ...
    test("two MuscleGroupIdResponse instances with null values should be equal",
        () {
      // Arrange
      const response1 = MuscleGroupIdResponse(
        message: null,
